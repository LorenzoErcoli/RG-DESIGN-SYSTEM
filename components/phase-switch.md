...
| `rg-scope-band` | **1.31.0.** La **fascia d'ambito**: primo figlio del blocco, **sopra** `__department`, quando la fase vale per tutto il prodotto e non per una parte. Nera piena, da bordo a bordo. Vedi [scope](scope.md). |
